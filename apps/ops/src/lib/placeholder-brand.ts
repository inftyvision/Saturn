 ...
 *
 * The floor if the Gaia workspace is missing. Ops has exactly one brand, so
 * this should never render in practice — it exists so a checkout without the
 * workspace still boots something legible.
 *
